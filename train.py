...
from MPDD.models.custom.custom_model import customModel as ourModel  # αλλαγή: import customModel
from dataset import *
from MPDD.custom_dataset import AudioVisualDataset  # αλλαγή: import custom dataset
